...
datasets = ['own_wms_Agriculture', 'own_wms_Biodiversity', 'own_wms_Climate', 'own_wms_Disaster', \
...
def evaluate_result():
    ...
    strlabel2 = 'result/wms 80 result_label.npy'
    strpred2 = 'result/wms 80 result_predict.npy'
    ...
    def precision(test, pre):
        ...
        stringpath2 = 'gcn-sw/wms gcn-multi result precision.txt'
