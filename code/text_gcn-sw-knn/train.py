...
datasets = ['20ng', 'R8', 'R52', 'ohsumed','mr','own_layer_Agriculture','own_layer_Biodiversity','own_layer_Climate','own_layer_Disaster',\
...
#f.close()
np.save(strlabel, test_labels)
np.save(strpred, test_pred)
